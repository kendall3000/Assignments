			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right">
						...
						<li><a class="page-scroll" href="index.php?page=work">Work</a></li>
						<li><a class="page-scroll" href="index.php?page=school">School</a></li>
						<li><a class="page-scroll" href="index.php?page=hobbies">Hobbies</a></li>
						<li><a class="page-scroll" href="index.php?page=contact">Contact</a></li>
					</ul>
				</div>
				<!-- /.navbar-collapse -->
			</div>
...
?>
		<footer>
			...
			<p id="back-top">
				<a href="#top"><i class="fa fa-angle-up">Top</i></a>
			</p>
		</footer>

...
document.addEventListener('DOMContentLoaded', function() {
	...
	function checkName(element) {
		...
		var validRegex = /^[A-Za-z'-]+$/; // Updated regex to allow alphabetical characters, hyphens, and apostrophes
		if (!name.match(validRegex) || !name.trim()) {
			showError(element, 'Name must contain only alphabetical characters, hyphens, or apostrophes and cannot be empty');
		} else {
			showSuccess(element);
		}
	}
